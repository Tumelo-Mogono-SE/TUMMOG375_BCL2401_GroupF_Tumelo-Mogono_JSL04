...
let stocks = cansLeft < 5 ? "Time to restock" : "We're stocked";
console.log(`${stocks}`);
...
let energy = heartRate < 100 ? "Boost needed" : "Energy levels are high!"
console.log(`${energy}`);
...
let chilledOrNot = currentTemp  <= 5 ? "Chilled to perfection!" : "Needs a cooler!";
console.log(`${chilledOrNot}`);
...
// If it's between 7am and midnight (24-hour format), print "Unleash the beast!"
// Otherwise, print "Better stick to water."
let drinkingHours = currentHour > 7 && currentHour < 24 ? "Unleash the beast" : "Better stick to water";
console.log(`${drinkingHours}`);
